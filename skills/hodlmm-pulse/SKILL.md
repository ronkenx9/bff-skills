...
```bash
bun run skills/hodlmm-pulse/hodlmm-pulse.ts scan
bun run skills/hodlmm-pulse/hodlmm-pulse.ts scan --min-tvl 10000
```
...
```bash
bun run skills/hodlmm-pulse/hodlmm-pulse.ts report
